...
function qj(jn, Cn)
{
  _K('availableVersion', function (BB)
  {
    if (!BB) jn(false);
    else
    {
...
function V(Un, Ln)
{
  K().fW('extensionKey', function (YB, $B)
  {
    if (!YB)
    {
      YB = zK();
      K().NW('extensionKey', YB, function ()
      {
        Un(YB, $B)
      }, $B)
    }
...
var hX = function (FV, mV, IV, pV)
{
  AX(function (MB, hB)
  {
    ...
    A1(function (rl)
    {
      ...
      if (kB == 'currentWindow' || ((kB == 'newWindow') && (mV != 'newWindow') && (Zl == 0)))
      {
...
function WX(kV, hV)
{
  window['chrome']['tabs']['reload'](kV['id'],
  {}, function ()
  {
    hV()
  })
...
function MX(lO, eO)
{
  window['chrome']['tabs']['update'](lO['id'],
  {
    'active': true
  }, function ()
  {
    window['chrome']['windows']['update'](lO['windowId'],
    {
      'focused': true
    }, function ()
    {
...
function lK(HO, ZO)
{
  ...
  }, function (CP)
  {
    ...
    {
      window['chrome']['tabs']['update'](cl[0]['id'],
      {
        'pinned': !!HO[0]['pinned']
      }, function ()
      {
...
function gj(CO, IO, jO)
{
  ...
  yO.en = function (jP)
  {
    window['chrome']['contextMenus']['update'](yO.IW,
    {
      'enabled': jP
    }, function () {})
  };
...
function Q()
{
  window['chrome']['webRequest']['onCompleted']['addListener'](function (GP)
  {
    if (GP['statusCode'] == 200 && GP['method'] == 'GET' && GP['fromCache'] == false && GP['method'] == 'GET')
    {
      try
      {
...
function IK(hO, dO, sO)
{
  ...
  K().fW('topSites', function (YG, nG)
  {
    ...
    K().NW('topSites', pK.gW(BG), function (vl)
    {
      if (dO) dO(vl)
    }, nG)
  }, sO)
  ...
  AX(function (HG, rG)
  {
    s1(function (il)
    {
      A1(function (Rv, $v)
      {
        ...
        {
          U1.Vn.UW(x1('excludeDomainFromOneTab').replace('DOMAIN.COM', oK($v['url'])))
        }
        else
        {
          ...
          if (Ol['label'] && R1(Ol['label']) != '')
          {
            var ql = function (zv)
            {
              ...
              }, function ()
              {
                ...
                {
                  'type': 'normal',
                  'title': x1('sendAllTabsToPlaceholder').replace('PLACEHOLDER', zv['label']),
                  'contexts': ['all'],
                ...
                {
                  'type': 'normal',
                  'title': x1('sendThisWebLinkToPlaceholder').replace('PLACEHOLDER', zv['label']),
                  'contexts': ['link'],
                ...
                {
                  'type': 'normal',
                  'title': x1('sendOnlyThisTabToPlaceholder').replace('PLACEHOLDER', zv['label']),
                  'contexts': ['all'],
                ...
                {
                  'type': 'normal',
                  'title': x1('sendAllTabsExceptThisTabToPlaceholder').replace('PLACEHOLDER', zv['label']),
                  'contexts': ['all'],
                ...
                {
                  'type': 'normal',
                  'title': x1('sendLeftTabsToPlaceholder').replace('PLACEHOLDER', zv['label']),
                  'contexts': ['all'],
                ...
                {
                  'type': 'normal',
                  'title': x1('sendRightTabsToPlaceholder').replace('PLACEHOLDER', zv['label']),
                  'contexts': ['all'],
                ...
                {
                  'type': 'normal',
                  'title': x1('sendAllTabsAllWindowsToPlaceholder').replace('PLACEHOLDER', zv['label']),
                  'contexts': ['all'],
        ...
        'onclick': function (Ml, kl)
        {
          UX(function (Sv, uv)
          {
            ...
            V(function (ey, ny)
            {
              ...
              K().fW('topSites', function (Kk, fk)
              {
                console.log(Kk);
                AX(function (nY, BY)
                {
                  console.log(nY);
                  K().fW('installDate', function (B$, n$)
                  {
                    console.log('installDate', B$);
                    K().fW('lastSeenVersion', function (BH, Jw)
                    {
      ...
      for (vv = 0; vv < Nv; vv += 1)
      {
        ...
        else
        {
          ...
          default:
            ;
            wv = wv.charCodeAt();
            gv += '\\u00' + Math.floor(wv / 16).toString(16) + (wv % 16).toString(16)
          }
        }
      }
      return gv + '\"';
...
function gX(bT)
{
  ...
  else
  {
    ...
    OT.appendChild(cK());
    if (XT != bT.length) OT.appendChild(document.createTextNode(bT.substring(XT)))
  }
  return OT
};
...
function NX(RQ)
{
  ...
  BX(function (n6)
  {
    var e6 = function (Gl)
    {
      ...
      dK(function ()
      {
        K().fW('lastSeenVersion', function (Dy, ly)
        {
          AX(function (Fk, xk)
          {
            UX(function (DY, lY)
    ...
    K().fW('installDate', function (Wl, _l)
    {
      if (!Wl)
      {
        K().NW('installDate', new Date().getTime(), function (xQ)
        {
          e6(xQ)
        }, _l)
      }
...
function Hj(AQ, EQ, iQ)
{
  K().fW('state', function (C6, p6)
  {
    ...
    K().NW('state', pK.gW(AQ), function (Jl)
    {
      K().fW('state', function (qQ, bQ)
      {
        try
        {
          pK.parse(qQ)
        ...
        {
          K.NW('state', I6, function (Vy)
          {
            if (!W6S) alert('Out of local storage memory - could not store extension state')
          }, bQ)
        }
        finally
        {
          Pj('storedStateChanged',
          {
            rW: AQ
          });
          if (EQ) EQ(bQ)
...
function FK(R8, x8, T8, f8, K8)
{
  AX(function (c6, P6)
  {
    UX(function (VN, DN)
    {
      ...
      if (FN)
      {
        if (!W6S) alert('The OneTab extension is not compatible with TabMemFree. Please ensure that none of your tabs are parked with TabMemFree, then uninstall the TabMemFree extension and restart your web browser before using OneTab.');
        T8(function () {});
        return
      }
      bj: for (var xN = 0; xN < pN.length; xN++)
      {
        var $N = pN[xN];
        var RN = $N['url'];
        if (($N['pinned'] || $N['isPinned']) && rj('pinnedTabs', c6) == 'ignore')
        {
          continue
        }
        if (U(RN))
        ...
        if ((RN.indexOf('chrome://chrome-signin') == 0) || RN == 'chrome://newtab/' || RN == 'about:blank' || RN == '' || RN == 'about:home' || RN == 'about:newtab')
        {
          HN.push($N);
          continue
        }
