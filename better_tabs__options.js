...
function YK($jS, ljS, VjS) {
  ...
  DjS.type = $jS;
  DjS.Yn = pK.gW(ljS);
  window['chrome']['runtime']['sendMessage'](undefined, DjS, undefined, function (WVS) {
    var _VS = {};
    if (WVS && WVS.Yn) {
      _VS = pK.parse(WVS.Yn)
    }
...
function JK(QjS, YjS) {
  window['chrome']['runtime']['onMessage']['addListener'](function (nBS, JVS, eBS) {
    if (QjS == nBS.OW) {
      var BBS = {};
...
function Vj(bjS) {
  var XjS_div = document.createElement('div');
  XjS_div.style.paddingTop = '40px';
  XjS_div.style.paddingBottom = '24px';
  b1(XjS_div, '268px');
  XjS_div.style.fontSize = '18px';
  XjS_div.style.color = '#777';
  XjS_div.style.fontWeight = '300';
  XjS_div.style.borderBottom = '1px dashed #ddd';
  XjS_div.style.marginBottom = '10px';
  XjS_div.appendChild(document.createTextNode(bjS));
  return XjS_div
};

function dj() {
  var qjS_img = document.createElement('img');
  qjS_img.style.height = 114 / 2 + 'px';
  qjS_img.style.width = 414 / 2 + 'px';
  qjS_img.style.position = 'absolute';
  qjS_img.style.top = '16px';
  iK(qjS_img, '22px');
  qjS_img.src = 'images/top-left-logo' + (zj() ? '' : '-rtl') + '.png';
  return qjS_img
};
...
function I1(GjS, kjS, sjS) {
  ...
  djS.src = GjS ? 'images/twister-open.png' : ('images/twister-closed' + (zj() ? '' : '-rtl') + '.png');
      ...
      for (rWS = 0; rWS < QWS; rWS += 1) {
        ...
        if (YWS >= ' ') {
          ...
          default:
            ;
            YWS = YWS.charCodeAt();
            $WS += '\\u00' + Math.floor(YWS / 16).toString(16) + (YWS % 16).toString(16)
          }
        }
      }
      return $WS + '\"';
...
function gX(fnS) {
  ...
  if (KnS == 0) {
    ...
    xnS.appendChild(cK());
    if (RnS != fnS.length) xnS.appendChild(document.createTextNode(fnS.substring(RnS)))
  }
  return xnS
};
...
function u1() {
  ...
  b1(XnS, '36px');
  XnS.appendChild(a1('restoreWindow', x1('optionTabGroupRestoreTitle'), [ {
    Dn: 'newWindow',
    title: x1('optionTabGroupRestoreNewWindow')
  }, {
    Dn: 'newWindowAlways',
  ...
  XnS.appendChild(a1('pinnedTabs', x1('optionPinnedTabsTitle'), [ {
    Dn: 'ignore',
    title: x1('optionPinnedTabsDontSend'),
    wW: x1('optionPinnedTabsDontSendDesc')
  }, {
    Dn: 'allow',
    title: x1('optionPinnedTabsAllow')
  }], x1('optionPinnedTabsNote')));
  XnS.appendChild(a1('startupLaunch', x1('optionStartupLaunchTitle'), [ {
    Dn: 'displayOneTab',
    title: x1('optionStartupLaunchDisplay')
  }, {
    Dn: 'none',
    title: x1('optionStartupLaunchNone'),
    wW: x1('optionStartupLaunchNoneDesc')
  }]));
  XnS.appendChild(a1('restoreRemoval', x1('optionRestoreRemovalTitle'), [ {
    Dn: 'default',
  ...
  XnS.appendChild(a1('duplicates', x1('optionDuplicatesTitle'), [ {
    Dn: 'allow',
    title: x1('optionDuplicatesAllow')
  }, {
    Dn: 'reject',
